...
namespace UbyApi.Controllers
{
    ...
    public class TipoComercioController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<TipoComercioItem>>> GetTipoComercios()
        {
            return await _context.TipoComercios.ToListAsync();
        }
        ...
        {
            var tipoComercioItem = await _context.TipoComercios.FindAsync(id);
        ...
        {
            _context.TipoComercios.Add(tipoComercioItem);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> DeleteTipoComercioItem(int id)
        {
            ...
            _context.TipoComercios.Remove(tipoComercioItem);
            await _context.SaveChangesAsync();
        ...
        {
            return _context.TipoComercios.Any(e => e.Id == id);
        }
    }
}
